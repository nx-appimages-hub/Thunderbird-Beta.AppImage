...
all: 
	...
	cp --force --recursive $(PWD)/build/thunderbird $(PWD)/build/AppDir/
	...
	export ARCH=x86_64 && $(PWD)/bin/appimagetool.AppImage $(PWD)/build/AppDir $(PWD)/Thunderbird-Beta.AppImage
